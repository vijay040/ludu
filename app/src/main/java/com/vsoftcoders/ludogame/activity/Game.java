...
import com.vsoftcoders.ludogame.BuildConfig;
import com.vsoftcoders.ludogame.util.MySoundPool;
import com.vsoftcoders.ludogame.view.CanvasBoardDraw;
...
public class Game extends Activity implements View.OnClickListener, View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pool = new MySoundPool();

        new SweetAlertDialog(this, SweetAlertDialog.WARNING_TYPE)
                .setTitleText("***Game Rules***")
                .setContentText(getString(R.string.game_rule))
                .setConfirmText("Ok")
                .show();
    ...
    public void checkVersionUpdate() {
        ...
        if (currentVersion != null && onlineVersion != null) {
            if (Float.valueOf(currentVersion) < Float.valueOf(onlineVersion)) {
                SweetAlertDialog alert = new SweetAlertDialog(Game.this, SweetAlertDialog.WARNING_TYPE);
                ...
                alert.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    ...
                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                        ...
                        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.vsoftcoders.ludogame"));
